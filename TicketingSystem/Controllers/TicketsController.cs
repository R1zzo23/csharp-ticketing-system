...
namespace TicketingSystem.Controllers
{
    ...
    public class TicketsController : Controller
    {
        ...
        {
            var tickets = await _context.Ticket.Where(p => p.Closed == false).ToListAsync();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TicketId,Name,Closed,OpenedBy")] Ticket ticket)
        {
